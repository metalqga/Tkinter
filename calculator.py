...
#Define Buttons
button_1 = Button(root, text = "1",font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command = lambda: button_click(1))
button_2 = Button(root, text = "2", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command = lambda: button_click(2))
button_3 = Button(root, text = "3", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(3))
button_4 = Button(root, text = "4", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(4))
button_5 = Button(root, text = "5",font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(5))
button_6 = Button(root, text = "6", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(6))
button_7 = Button(root, text = "7", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(7))
button_8 = Button(root, text = "8", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(8))
button_9 = Button(root, text = "9", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(9))
button_0 = Button(root, text = "0", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: button_click(0))
...
button_decimal = Button(root, text = ".", font=('Times', '24', 'bold'), borderwidth=5, padx=23, pady=20, command=lambda: button_click("."))
button_equal = Button(root, text = "=", font=('Times', '24', 'bold'), borderwidth=5, padx=20, pady=20, command=lambda: equal(sign))
...
button_percent = Button(root, text = "%", font=('Times', '24', 'bold'), borderwidth=5, padx=18, pady=18, command=percentage)
...
button_plusminus = Button(root, text = "+/-", font=('Times', '24', 'bold'), borderwidth=5, padx=14, pady=20, command=plusminus)
#memory indicator
