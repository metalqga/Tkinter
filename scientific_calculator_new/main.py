...
def button_click(number):
    ...
    current = e.get(END)
    cursor_position = e.index(tkinter.INSERT)
    # e.delete(index1=1.0, index2=END)
    e.insert(cursor_position, str(current) + str(number))
...
button_sqrtx = Button(root, text="x√", font=('Times', '12', 'bold'),width=5,  borderwidth=1, padx=0, pady=0, command = lambda: button_click("**1/"))
